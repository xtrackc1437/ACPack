...
scoreboard objectives add stats.player_death dummy "死亡量"
...
scoreboard objectives add stats.player_mine dummy "挖掘量"
...
scoreboard objectives add stats.player_hoe dummy "锄头使用量"
...
scoreboard objectives add stats.player_container_use dummy "容器打开次数"

scoreboard objectives add stats.traded_with_villager minecraft.custom:traded_with_villager "村民交易次数"
scoreboard objectives add stats.player_traded_with_villager dummy "村民交易次数"
# 计时器
