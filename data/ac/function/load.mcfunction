...
tellraw @a [{text:"开发: ",color:"aqua",bold:true},{text:"AreoCraft Developers",color:"aqua",hover_event:{action:"show_text",value:"点击访问源代码仓库"},click_event:{action:"open_url",url:"https://github.com/misividkoukou/ACPack"}},{text:"   "},{text:"[关于AreoCraft]",color:"aqua",hover_event:{action:"show_text",value:"审核Q群：176629694"},click_event:{action:"open_url",url:"https://areocraft.zhangrx.top"}}]
tellraw @a {text:" "}
#### 计分板 ####
# sweeper
